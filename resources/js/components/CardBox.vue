...
<template>
    <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        ...
        <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><a href="#">Seminar Nasional Udayana</a></h2>
        ...
        <div class="flex justify-between items-center">
            ...
            <a href="#" class="inline-flex items-center font-medium text-blue-600 dark:text-primary-500 hover:underline">
                Read more
