...
<AppLayout :breadcrumbs="breadcrumbs">
    ...
    <div class="max-w-4xl mx-auto p-6 space-y-6">
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-foreground mb-2">Edit Registration</h1>
            <p class="text-muted-foreground">Edit and customize your registration form</p>
        </div>
            ...
            <CardContent class="space-y-6">
                ...
                <div class="space-y-3">
                    ...
                    <div v-if="registrationDetails.poster" class="space-y-3">
                        <div class="flex items-center justify-between p-3 bg-background rounded-lg w-full">
                        ...
                        <div class="space-y-6 w-full">
                            ...
                            <div class="space-y-4 w-full">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex items-center gap-3">
                                        <Badge :variant="isRegistrationOpen ? 'default' : 'secondary'"
                                            :class="isRegistrationOpen ? 'bg-muted text-green-600' : 'bg-muted text-red-500'">
                                ...
                                <div v-if="showDateWarning" class="mt-4 w-full">
                                    <Alert class="border-muted bg-muted/30 w-full flex">
                                        <AlertCircle class="w-4 h-4 text-foreground" />
                                        <AlertDescription class="text-foreground text-wrap w-full">
                                ...
                                <div v-if="showManualCloseWarning" class="mt-4 w-full">
                                    <Alert class="border-muted bg-muted/30 w-full flex">
                                        <AlertCircle class="w-4 h-4 text-wrap" />
                                        <AlertDescription class="text-foreground text-wrap w-full">
        ...
        <Card>
            ...
            <CardContent>
                <div class="space-y-4">
                    ...
                    <!-- Empty State -->
                    <div v-if="formDetails.questions.length === 0" class="text-center py-8 text-muted-foreground">
        ...
        <div class="flex justify-center gap-4 pt-4">
            <AlertDialog>
                <AlertDialogTrigger as-child>
                    <Button variant="destructive" class="px-8">
