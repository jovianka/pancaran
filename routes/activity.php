...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/event/{id}', [ActivityDetailController::class, 'show'])->name('activity.detail');
    Route::post('/event/{id}/leave', [ActivityDetailController::class, 'leave'])->name('activity.leave');
    ...
    // Members page
    Route::post('event/members/invitation', [MembersController::class, 'sendInvitation'])->middleware('throttle:30,1')->name('members.sendInvitation');
